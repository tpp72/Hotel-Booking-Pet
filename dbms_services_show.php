...
<head>
  ...
  <title>Pet Hotel :: แสดงข้อมูลบริการเสริม</title>
    ...
    <form method="post" action="">
        <div class="container">
            ...
            <div class="text-center mb-4">
                <a href="dbms_services_insert.php" class="btn btn-primary">เพิ่มข้อมูลบริการเสริม</a>
                <a href="dbms_services_update.php" class="btn btn-secondary">แก้ไขข้อมูลบริการเสริม</a>
                <a href="dbms_services_delete.php" class="btn btn-danger">ลบข้อมูลบริการเสริม</a>
            </div>
...
<?php
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<td width='55%'><center>ชื่อบริการเสริม</center></td>";
