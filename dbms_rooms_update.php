    ...
    <form method="post" action="">
        <div class="container">
            ...
            <div class="text-center mb-4">
                <a href="dbms_rooms_insert.php" class="btn btn-primary">เพิ่มข้อมูลการจองห้องพัก</a>
                <a href="dbms_rooms_update.php" class="btn btn-secondary">แก้ไขข้อมูลการจองห้องพัก</a>
                <a href="dbms_rooms_delete.php" class="btn btn-danger">ลบข้อมูลการจองห้องพัก</a>
            </div>
...
<?php
    ...
    while($result_array = $result->fetch_assoc()) {
        ...
        echo "<td><center><a href='dbms_rooms_update2.php?val=".md5($result_array['room_id'])."'target='_self' role='button' class='btn btn-secondary'>แก้ไข</a></center></td>";
        echo  "</tr>";
    }
        echo "</table>";
    }else{
