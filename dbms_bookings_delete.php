...
<?php
    ...
    while($result_array = $result->fetch_assoc()) {
        ...
        echo "<td><center><a href='dbms_exec.php?val=".md5($result_array['booking_id'])."&bookings_chk=delete' target='_self' onclick='return confirm(\"ยืนยันการลบข้อมูล\")' role='button' class='btn btn-danger'>ลบ</a></center></td>";
        echo  "</tr>";
    }
        echo "</table>";
    }else{
